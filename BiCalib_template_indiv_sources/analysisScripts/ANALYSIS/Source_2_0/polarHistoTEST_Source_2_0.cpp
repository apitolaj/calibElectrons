...
void polarHistoTEST_angles_2_0(const char* filename)
{
    gStyle->SetOptStat(0);
    ...
    c->Update();
    c->SaveAs("polarHisto_Source_2_0.png");
    ...
    if (okEnv && okNoEnv)
    {
        ...
        cRatio->Update();
        cRatio->SaveAs("polarHisto_Source_2_0_ratios.png");
    }
    else
    {
        std::cerr
