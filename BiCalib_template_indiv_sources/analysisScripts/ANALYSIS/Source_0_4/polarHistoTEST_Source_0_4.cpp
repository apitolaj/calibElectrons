...
void polarHistoTEST_angles_0_4(const char* filename)
{
    gStyle->SetOptStat(0);
    ...
    c->Update();
    c->SaveAs("polarHisto_Source_0_4.png");
    ...
    if (okEnv && okNoEnv)
    {
        ...
        cRatio->Update();
        cRatio->SaveAs("polarHisto_Source_0_4_ratios.png");
    }
    else
    {
        std::cerr
