                 ...
                 TVirtualPad* rightPad)
{
    ...
    DrawHemisphere(tree, false, leftHistName.c_str(),  leftTitle.c_str(),  leftPad,  true);
    DrawHemisphere(tree, true,  rightHistName.c_str(), rightTitle.c_str(), rightPad, false);
...
void polarHisto_SOURCE_PLACEHOLDER(const char* filename)
{
    gStyle->SetOptStat(0);
    ...
    bool okEnv = DrawTreeRow(
        f,
        "envelope",
        "Source SOURCE_PLACEHOLDER (Env., ENERGY_PLACEHOLDER)",
        "env",
        c->GetPad(1),
        c->GetPad(2));
    ...
    bool okNoEnv = DrawTreeRow(
        f,
        "noEnvelope",
        "Source SOURCE_PLACEHOLDER (No env., ENERGY_PLACEHOLDER)",
        "noenv",
        c->GetPad(3),
        c->GetPad(4));
