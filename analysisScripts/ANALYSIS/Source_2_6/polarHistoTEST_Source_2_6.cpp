...
void polarHistoTEST_angles_2_6(const char* filename)
{
    gStyle->SetOptStat(0);
    ...
    c->Update();
    c->SaveAs("polarHisto_Source_2_6.png");
    ...
    if (okEnv && okNoEnv)
    {
        ...
        cRatio->Update();
        cRatio->SaveAs("polarHisto_Source_2_6_ratios.png");
    }
    else
    {
        std::cerr
